...
public class CarSalesSystem extends JFrame implements ActionListener, ComponentListener
{
	...
	private JLabel carCoLabel = new JLabel("CAR BAAJAAR", JLabel.CENTER);
	private JLabel salesSysLabel = new JLabel("Karan Gupta & Govind Kumar", JLabel.CENTER);
	...
	public CarSalesSystem(String f)
	{
		...
		pictureLabel.setMinimumSize(new Dimension(370,300));
		pictureLabel.setPreferredSize(new Dimension(370,300));
		pictureLabel.setMaximumSize(new Dimension(370,300));
